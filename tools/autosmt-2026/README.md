...
- `scripts/test-course-delivery.mjs`: builds and removes a temporary course to verify resource-closure checks, split media/simulation delivery, the full backup, assetBase, and SHA-256 reporting.
